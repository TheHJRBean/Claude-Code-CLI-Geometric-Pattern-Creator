...
**Next:** ⏳ BROWSER-VERIFY (Decoration phase → Gradient target → Across frame → Enable → drag handles → confirm unpainted Voids fill with one continuous wash, painted Voids cover it, linear↔radial, save/reload). Then #46 (v2 strand gradients) unblocks.
