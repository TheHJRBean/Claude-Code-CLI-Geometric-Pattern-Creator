...
Authoritative design context lives in `TESSELLATION_REVAMP_PLAN.md` (Step 17 section) and `SESSION_STATE.md` (resume anchor). Seven multi-cell Configurations ship (4.8.8, 3.12.12, 4.6.12, 3.6.3.6, 3.4.6.4, 3.3.3.4.4 via ticket #11, and 3.3.4.3.4 snub square via ticket #14). Step 17.12 boundary-inward (single-shape v1) and Step 17.13 vertex placement are delivered.
