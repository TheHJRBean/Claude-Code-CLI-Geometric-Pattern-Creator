...
**✅ Lever A browser-verified (2026-06-05, user):** with the flag on, the strand angle slider is **smooth** (compute fix confirmed) — BUT **overall pan/zoom perf is not much improved.** This is the key diagnostic conclusion: **the dominant remaining bottleneck is the PAINT axis (Lever B), not compute.** So next priority is Lever B, NOT generalising Lever A.
