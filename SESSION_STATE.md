...
6. **Decoration stamps v2 (Sonnet/Opus).** v1 ships for Voids only; Overlap + stacking order + the Mirror ladder + Focus-mode Flip landed 2026-08-02. Remaining = **Tile**-stamping, ladder rungs (cell/patch/instance), asset library. Memory: `project_decoration_stamps_idea.md`.
