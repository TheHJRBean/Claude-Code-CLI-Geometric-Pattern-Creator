...
2. ~~**Decide (c) — the 1.5° curve cliff.**~~ ✅ **DONE 2026-08-02 (`a97e079`)**, ⏳ browser-verify — folded into item 1's pass: set a **gentle** curve (offset ~0.02–0.03) and confirm the Void fill / stamp canvas / Focus outline now bow with the strands instead of snapping to the chord. Sanity-check a heavy field for paint responsiveness while you're there — the measurement says no new cost regime, but that was measured on extraction, not on 60-point SVG fills under a fast pan.
