...
- `editor/active.ts` — adapter layer (`activeCell` / `allCells` / `withActiveCell`) used by the reducer + Canvas to route between Patch-level and active-Cell mutations.
