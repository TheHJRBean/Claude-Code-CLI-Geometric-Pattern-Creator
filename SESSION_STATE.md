...
**Offered, awaiting the user's word:** a legacy Frame is seeded centred on the **world origin** at half-extent 400, and a legacy field is infinite — so on some presets the default outline lands mid-motif instead of on a symmetric point. The origin nudge pad covers it; seeding the Frame from the **current view** instead of (0,0) is the alternative and was offered, not built.
