...
const TIER1 = ['square', 'hexagonal', 'triangular', '4.8.8', '3.12.12', '4.6.12', '3.6.3.6', '3.4.6.4', '3.3.3.4.4']
const NON_CONVERTIBLE = ['cairo-pentagonal', 'rhombille', 'decagonal-rosette', '3.3.4.3.4', '3.3.3.3.6', 'no-such-tiling']
...
describe('convertPresetToEditorConfig — tier-1 table', () => {
  ...
  it('multi-cell presets keep their Configuration id', () => {
    for (const type of ['4.8.8', '3.12.12', '4.6.12', '3.6.3.6', '3.4.6.4', '3.3.3.4.4'] as const) {
      const out = convertPresetToEditorConfig(presetConfig(type))!
